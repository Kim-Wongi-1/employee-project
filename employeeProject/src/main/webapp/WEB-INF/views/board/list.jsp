	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
							...
							<c:when test="${!empty list}">
								<c:forEach items="${list}" var="board">
									<tr class="odd gradeX">
										...
										<td>
											<a class="move" href="<c:out value="${board.b_no}" />">
												<c:out value="${board.title}" /> 
												<c:if test="${board.reply_cnt > 0}">
													 <i class="fa fa-comments">	<c:out value="${board.reply_cnt}" /> </i>
												</c:if>
											</a>
										</td> 
				...
				<button id="regBtn" type="button" data-oper="modify" class="btn btn-success pull-left ">글쓰기</button>
